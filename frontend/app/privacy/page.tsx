  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="prose prose-invert max-w-none text-slate-300 space-y-6 text-sm leading-relaxed">
        ...
        <h2 className="text-lg font-bold text-white mt-6 border-b border-slate-850 pb-2">Log Files</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-white mt-6 border-b border-slate-850 pb-2">Cookies and Web Beacons</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-white mt-6 border-b border-slate-850 pb-2">Google DoubleClick DART Cookie</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-white mt-6 border-b border-slate-850 pb-2">Advertising Partners Privacy Policies</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-white mt-6 border-b border-slate-850 pb-2">Consent</h2>
        <p>
