    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      <div className="border-b border-slate-800 pb-6">
        <h1 className="text-3xl font-extrabold text-white flex items-center gap-2">
          <Shield className="h-8 w-8 text-emerald-400" /> Privacy Policy
        </h1>
      ...
      <div className="prose prose-invert max-w-none text-slate-300 space-y-6 text-sm leading-relaxed">
        <p>
          At <strong>railwayadmitcard.online</strong>, accessible from <Link href="/" className="text-emerald-400 underline">https://railwayadmitcard.online</Link>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by railwayadmitcard.online and how we use it.
        </p>

        <h2 className="text-lg font-bold text-white mt-6 border-b border-slate-800 pb-2">Log Files</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-white mt-6 border-b border-slate-800 pb-2">Cookies and Web Beacons</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-white mt-6 border-b border-slate-800 pb-2">Google DoubleClick DART Cookie</h2>
        <p>
          Google is one of the third-party vendors on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to railwayadmitcard.online and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer" className="text-emerald-400 underline">https://policies.google.com/technologies/ads</a>.
        </p>

        <h2 className="text-lg font-bold text-white mt-6 border-b border-slate-800 pb-2">Advertising Partners Privacy Policies</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-white mt-6 border-b border-slate-800 pb-2">Consent</h2>
        <p>
