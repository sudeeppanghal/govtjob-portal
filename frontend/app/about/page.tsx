    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      <div className="border-b border-slate-200 pb-6">
        <h1 className="text-3xl font-extrabold text-slate-900 flex items-center gap-2">
          <Landmark className="h-8 w-8 text-blue-600" /> About Us
        </h1>
      ...
      <div className="prose max-w-none text-slate-600 space-y-6 text-sm leading-relaxed">
        ...
        <h2 className="text-lg font-bold text-slate-900 mt-6 border-b border-slate-200 pb-2">Our Mission</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-slate-900 mt-6 border-b border-slate-200 pb-2">How Our Platform Works</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-slate-900 mt-6 border-b border-slate-200 pb-2">Important Notice</h2>
