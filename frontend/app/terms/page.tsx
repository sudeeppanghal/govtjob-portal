  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="prose max-w-none text-slate-600 space-y-6 text-sm leading-relaxed">
        ...
        <h2 className="text-lg font-bold text-slate-900 mt-6 border-b border-slate-200 pb-2">Disclaimer of Government Affiliation</h2>
        <p className="text-amber-700 font-semibold bg-amber-50 border border-amber-200 p-4 rounded-lg">
        ...
        <h2 className="text-lg font-bold text-slate-900 mt-6 border-b border-slate-200 pb-2">Intellectual Property Rights</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-slate-900 mt-6 border-b border-slate-200 pb-2">Restrictions</h2>
        ...
        <h2 className="text-lg font-bold text-slate-900 mt-6 border-b border-slate-200 pb-2">No Warranties</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-slate-900 mt-6 border-b border-slate-200 pb-2">Limitation of Liability</h2>
        <p>
