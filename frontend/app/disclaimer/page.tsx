    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      <div className="border-b border-slate-200 pb-6">
        <h1 className="text-3xl font-extrabold text-slate-900 flex items-center gap-2">
          <AlertTriangle className="h-8 w-8 text-amber-500" /> General Disclaimer
        </h1>
      ...
      <div className="prose max-w-none text-slate-600 space-y-6 text-sm leading-relaxed">
        <div className="bg-slate-50 border border-slate-200 p-6 rounded-xl space-y-4">
          <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2 m-0 text-amber-600">
        ...
        <h2 className="text-lg font-bold text-slate-900 mt-6 border-b border-slate-200 pb-2">Source of Information</h2>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>UPSC Official Site: <a href="https://upsc.gov.in" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">https://upsc.gov.in</a></li>
          <li>SSC Official Site: <a href="https://ssc.gov.in" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">https://ssc.gov.in</a></li>
          <li>RRB Chandigarh Site: <a href="https://www.rrbcdg.gov.in" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">https://www.rrbcdg.gov.in</a></li>
          <li>Press Information Bureau (PIB): <a href="https://pib.gov.in" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">https://pib.gov.in</a></li>
        </ul>

        <h2 className="text-lg font-bold text-slate-900 mt-6 border-b border-slate-200 pb-2">Verification & Accuracy</h2>
        <p>
