...
def extract_with_gemini(pdf_text: str, category: str, source_name: str) -> dict:
    ...
    system_instruction = (
        ...
        "JSON SCHEMA:\n"
        "{\n"
        "  \"article_title\": \"SEO-optimized, catchy title containing key terms in English, followed by a relevant Hindi translation/transliteration in parentheses to target bilingual Indian search queries (e.g., 'SSC CGL Recruitment 2026: Apply Online (एसएससी सीजीएल भर्ती)')\",\n"
        ...
        "    }\n"
        "  },\n"
        "  \"article_content\": \"Full markdown-formatted article written in BOTH English and Hindi. Structure the article content exactly as follows:\n\n"
        "     # English Version\n"
